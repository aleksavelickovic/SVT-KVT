...
VALUES ('Grand Hall', 'Large indoor venue suited for conferences and concerts.', '2025-10-20', '12 Market St, Belgrade',
       ...
       ('Conference Center Delta', 'Modern conference center with multiple meeting rooms.', '2025-07-01',
        '45 Business Rd, Kragujevac', 'CONFERENCE_CENTER', 3.77, 'turizam4.jpg'),
...
VALUES ('Tech Summit 2025', '12 Market St, Belgrade', 'CONFERENCE', CAST(current_date() AS DATE), 79.99, TRUE,
       ...
       ('Riverside Music Fest', 'Riverside Dr, Novi Sad', 'FESTIVAL', '2027-08-21', 0.00, TRUE,
        (SELECT id FROM locations WHERE name = 'Grand Hall'), 'riverside.jpg'),
